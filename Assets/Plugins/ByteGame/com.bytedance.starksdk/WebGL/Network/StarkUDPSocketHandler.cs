  ...
  #define STARK_UDP_ENABLED
#endif

using System;
using UnityEngine;

#if STARK_UDP_ENABLED
using System.Runtime.InteropServices;
using AOT;
#endif

namespace StarkSDKSpace.Network
{
    public class StarkUDPSocketHandler
    {

#if UNITY_EDITOR
            public const string NotImplMessage = "Stark UDP Socket not supported on Unity Editor. Test it with Douyin App.";
#elif UNITY_ANDROID
            public const string NotImplMessage = "Stark UDP Socket not supported on Android Native.";
#else
            public const string NotImplMessage = "Stark UDP Socket not supported on current platform.";
#endif
        ...
        public static void SetStarkSDKUDPSocketMessageCallback(Action<string, IntPtr, int, IntPtr, IntPtr> callback)
        {
