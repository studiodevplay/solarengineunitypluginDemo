...
namespace SolarEngine
{
    ...
    public partial class Analytics : MonoBehaviour
    {
        ...
        private static void Init(string appKey, string userId, SEConfig config)
        {
            ...
            {
                SolarEngineSDK4MiniGames.MiniGameInitCompletedCallback initCompletedCallback=  (SolarEngineSDK4MiniGames.MiniGameInitCompletedCallback)Delegate.CreateDelegate(typeof(SolarEngineSDK4MiniGames.MiniGameInitCompletedCallback), config.initCompletedCallback.Target, config.initCompletedCallback.Method);
            ...
            {
                SolarEngineSDK4MiniGames.MiniGameAttributionCallback attributionCallback=  (SolarEngineSDK4MiniGames.MiniGameAttributionCallback)Delegate.CreateDelegate(typeof(SolarEngineSDK4MiniGames.MiniGameAttributionCallback), config.attributionCallback.Target, config.attributionCallback.Method);
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
        public static void setReferrerTitle(string referrerTitle)
        {
        ...
        {
            SolarEngineSDK4MiniGames.getDistinct(Distinct);
        }   
#endif
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
            SolarEngineSDK4MiniGames.trackIAP(attributesDict,attributes.customProperties);
            return;
#endif
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
            SolarEngineSDK4MiniGames.trackAdImpression(attributesDict,attributes.customProperties);
            return;
#endif
            if (attributes.customProperties != null)
            {
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
            SolarEngineSDK4MiniGames.trackAdClick(attributesDict,attributes.customProperties);
            return;
#endif
            if (attributes.customProperties != null)
            {
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
            SolarEngineSDK4MiniGames.trackRegister(attributesDict,attributes.customProperties);
            return;
#endif
            if (attributes.customProperties != null)
            {
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
            SolarEngineSDK4MiniGames.trackLogin(attributesDict,attributes.customProperties);
            return;
#endif
            if (attributes.customProperties != null)
            {
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
            SolarEngineSDK4MiniGames.trackOrder(attributesDict,attributes.customProperties);
            return;
#endif
            if (attributes.customProperties != null)
            {
...
#if SOLARENGINE_BYTEDANCE||SOLARENGINE_WECHAT
            SolarEngineSDK4MiniGames.trackAppAttr(attributesDict,attributes.customProperties);
            return;
#endif
            if (attributes.customProperties != null)
            {
...
#if UNITY_ANDROID&&!SOLARENGINE_BYTEDANCE && !UNITY_EDITOR
